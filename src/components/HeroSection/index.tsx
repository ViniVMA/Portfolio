...
function HeroSection() {
  return (
    <div className="hero  flex flex-col justify-around sm:h-[86.5vh]">
      <div className="hero-content mt-32 flex flex-col h-full justify-between ">
        <div className="flex flex-row">
          <div className="max-w-screen-sm">
            ...
            <div className="mt-44 flex gap-4 w-full flex-wrap">
          ...
          <div className="w-full max-w-screen-md ">
            <img src="/avatar4.png" className=" w-full" />
          </div>
        </div>
      </div>
    </div>
